...
tier: core
pos: noun
forms: [appointment, appointments]
lists: [ngsl]
rank: 1839
sfi: 56.04
sources: [wordnet, llm]
...
## Examples
- the appointment had to be approved by the whole committee _(wordnet)_

## Connections
- synonym: [[assignment]]
- builds_on: [[date]] — Use 'appointment' when the specified day is set for a scheduled meeting or service, emphasizing a planned engagement.
