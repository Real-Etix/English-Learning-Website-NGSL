...
## Definition
The cathedral's vault soared overhead.

## Examples
_No sourced examples yet._

## Connections
- builds_on: [[arch]] — Use 'vault' instead of 'arch' when focusing on a curved ceiling or roof that spans a large area, often in architecture.
