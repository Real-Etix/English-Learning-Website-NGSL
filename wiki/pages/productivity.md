...
tier: core
pos: noun
forms: [productivity, productivities]
...
- domain: business
- domain: academic
- advanced_form: [[efficiency]] — Use 'efficiency' when focusing on doing things with less waste (time, energy, materials) rather than just the amount produced.
