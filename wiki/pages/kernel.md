...
## Definition
I cracked the shell to get the kernel.

## Examples
_No sourced examples yet._

## Connections
- builds_on: [[nut]] — Use 'kernel' when referring to the edible seed inside the hard shell, focusing on the inner part rather than the whole nut.
