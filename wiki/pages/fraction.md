...
- domain: business
- domain: academic
- advanced_form: [[cut]] — Use 'cut' instead of 'fraction' when referring to a specific portion separated by distillation, especially in petroleum refining.
