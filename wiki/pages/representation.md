...
tier: core
pos: noun
forms: [representation, representations]
lists: [ngsl]
rank: 2027
sfi: 55.47
sources: [wordnet, llm]
...
- builds_on: [[model]] — Use 'representation' instead of 'model' when highlighting how something is depicted or symbolized, often in a simplified or abstract form.
