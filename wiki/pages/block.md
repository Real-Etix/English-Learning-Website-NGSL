...
## Examples
- block the way _(wordnet)_

## Connections
- synonym: [[stop]]
- synonym: [[bar]]
- advanced_form: [[obstruct]] — Use when something physically blocks a path or passage, often with a sense of deliberate or accidental impediment.
