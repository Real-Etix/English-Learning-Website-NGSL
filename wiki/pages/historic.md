...
## Examples
- historic victories _(wordnet)_
- historical (or historic) times _(wordnet)_

## Connections
- synonym: [[historical]]
- builds_on: [[antique]] — Use 'historic' instead of 'antique' when the item has historical significance, not just old age.
