...
tier: core
pos: verb
forms: [mediate, mediates, mediated, mediating]
lists: [academic]
rank: 168
sfi: 57.953
sources: [wordnet, llm]
...
- domain: academic
- advanced_form: [[arbitrate]] — Use 'arbitrate' when the mediation is formal, often with a neutral third party making a binding decision.
