...
## Examples
- catch somebody doing something or in a certain state _(wordnet)_

## Connections
<!-- awaiting LLM enrichment: intensity / advanced_form -->
- advanced_form: [[detect]] — Use 'detect' when carefully noticing something hidden or not obvious, like a flaw or error, whereas 'catch' is more casual.
