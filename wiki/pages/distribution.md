...
tier: core
pos: noun
forms: [distribution, distributions]
...
- domain: business
- domain: academic
- advanced_form: [[dispersion]] — Use 'dispersion' when emphasizing the spread or variability of the data, rather than the entire arrangement of frequencies.
