...
tier: core
pos: noun
forms: [model, models, modeled, modeling, modelled, modelling]
lists: [ngsl]
rank: 485
sfi: 63.12
sources: [wordnet, llm]
...
## Examples
- the computer program was based on a model of the circulatory and respiratory systems _(wordnet)_

## Connections
- synonym: [[framework]]
- advanced_form: [[paradigm]] — Use 'paradigm' instead of 'model' when emphasizing a widely accepted framework or pattern that shapes thinking in a field.
