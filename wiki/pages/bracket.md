...
tier: core
pos: noun
forms: [bracket, brackets, bracketed]
...
- domain: business
- domain: academic
- advanced_form: [[tier]] — Use 'tier' when referring to a ranked or hierarchical level within a system, like income brackets or service levels.
