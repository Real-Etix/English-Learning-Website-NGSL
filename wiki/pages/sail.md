...
tier: core
pos: verb
forms: [sail, sails, sailed, sailing]
lists: [ngsl]
rank: 2116
sfi: 55.17
sources: [wordnet, llm]
...
- builds_on: [[drift]] — Use sail instead of drift when the motion is steady and graceful, like a ship moving with wind or current.
