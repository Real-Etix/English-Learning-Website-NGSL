...
## Definition
The manager decided to expunge the outdated files from the database.

## Examples
_No sourced examples yet._

## Connections
- builds_on: [[delete]] — Use 'expunge' for formal or legal contexts where removal is complete and often permanent, such as deleting records or evidence.
